...
const CreateNewCategory = (props) => {
  ...
  const getIcons = () => {
    ...
    var config = {
      method: "get",
      url: "https://referenceprojects-abkno.run-eu-central1.goorm.io/reactnative/geticons",
      headers: {},
      data: data,
    };
  ...
  const createNewCategory2 = async () => {
  ...
  const createNewCategory = () => {
    ...
    var config = {
      method: "post",
      url: "https://referenceprojects-abkno.run-eu-central1.goorm.io/reactnative/createnewcategory",
      headers: {
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)}>
        <Modal.Content maxWidth="400px" backgroundColor={"#292524"} color="white">
          ...
          <Modal.Body>
            ...
            <View>
              <View width={20}>
                <Ionicons name="fast-food" size={50} color={icon == "fast-food" ? "white" : "grey"} onPress={() => setIcon("fast-food")} />
              </View>
              {icons.map((a, b) => {
                return (
